...
import com.naveen.aiedemo.view.datetimepicker.adapter.DateOnlyPickerAdapter
import com.naveen.aiedemo.view.datetimepicker.adapter.DateTimePickerAdapter
import com.naveen.aiedemo.view.datetimepicker.adapter.PickerAdapter
import com.naveen.aiedemo.view.datetimepicker.adapter.TimeOnlyPickerAdapter
    ...
    companion object {
        ...
        fun show(fragmentManager: FragmentManager, tag: String, onSuccess : (Date) -> Unit, initialDate: Date? = null, pickerType: Int = DATE_TIME) {
          /*  createInstance(initialDate, pickerType)
            ...
            var test = createInstance(initialDate, pickerType)
                .apply { setOnSuccess(onSuccess) }

            test.show(fragmentManager, tag)
        }
